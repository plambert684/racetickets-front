...
import { Search, MapPin, Calendar, ChevronRight, Music, Users, Briefcase } from 'lucide-react';
  ...
  return (
      <div className="-mt-[104px]">
        ...
        <div className="relative h-[600px] flex items-center justify-center text-white text-center overflow-hidden">
          ...
          <video
              src={new URL('../assets/background_hero.mp4', import.meta.url).href}
              autoPlay
              loop
              muted
              playsInline
        ...
        <div className="relative z-20 container mx-auto px-4 max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-title font-bold mb-12 leading-tight uppercase tracking-tight">
            PARCE QUE LES PLUS BEAUX SOUVENIRS SE VIVENT DEVANT UNE SCÈNE.
          </h1>
          ...
          <div className="bg-white text-gray-900 p-2 flex flex-col md:flex-row shadow-2xl">
            ...
            <button className="bg-black text-white px-10 py-4 font-bold uppercase tracking-widest hover:bg-gray-900 transition-colors">
              Chercher
            </button>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-title font-bold mb-12 uppercase tracking-tight">Événements populaires</h2>
              ...
              {events.map((event) => (
                <div key={event.id} className="bg-white border border-gray-200 p-8 flex flex-col justify-between hover:shadow-lg transition-shadow">
                  ...
                  <div className="border-t border-gray-50 pt-6">
                    ...
                    <Link to={`/event/${event.id}`} className="bg-black text-white w-full py-4 px-6 flex justify-between items-center font-bold uppercase tracking-widest text-sm">
